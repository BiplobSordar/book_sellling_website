...
import { Link, Outlet, useNavigate } from 'react-router-dom'
import { HiViewGridAdd, HiOutlineFolder, HiOutlineSearch, HiOutlineBell, HiOutlineLogout } from 'react-icons/hi'
import { MdOutlineManageHistory, MdOutlineDashboard, MdOutlineSettings, MdOutlineMenu, MdEdit, MdAdd } from 'react-icons/md'
      ...
      <div className="flex-grow text-gray-800">
        ...
        <main className="p-6 sm:p-10 space-y-6">
          <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            ...
            <div className="flex flex-col md:flex-row items-start justify-end -mb-3">
              <Link to="/dashboard/manage-books" className="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3">
                <MdEdit className="flex-shrink-0 h-5 w-5 -ml-1 mt-0.5 mr-2" />
                Manage Books
              </Link>
              <Link to="/dashboard/add-new-book" className="inline-flex px-5 py-3 text-white bg-purple-600 hover:bg-purple-700 focus:bg-purple-700 rounded-md ml-6 mb-3">
                <MdAdd className="flex-shrink-0 h-6 w-6 text-white -ml-1 mr-2" />
                Add New Book
              </Link>
            </div>
          </div>
